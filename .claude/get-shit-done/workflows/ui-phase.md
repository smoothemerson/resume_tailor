...
```markdown
Read /workspace/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /workspace/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /workspace/.claude/agents/gsd-ui-checker.md for instructions.
