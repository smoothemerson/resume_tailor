...
<reference>
@/workspace/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/workspace/.claude/get-shit-done/references/user-profiling.md` to load:
