...
<required_reading>
@/workspace/.claude/get-shit-done/references/verification-patterns.md
@/workspace/.claude/get-shit-done/templates/verification-report.md
</required_reading>
...
See /workspace/.claude/get-shit-done/templates/verification-report.md for complete template.
</step>
