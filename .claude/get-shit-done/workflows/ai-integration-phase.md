...
<required_reading>
@/workspace/.claude/get-shit-done/references/ai-frameworks.md
@/workspace/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /workspace/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/workspace/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /workspace/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /workspace/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /workspace/.claude/agents/gsd-eval-planner.md for instructions.
