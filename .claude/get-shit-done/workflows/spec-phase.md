...
```bash
INIT=$(node "/workspace/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/workspace/.claude/get-shit-done/templates/spec.md.
