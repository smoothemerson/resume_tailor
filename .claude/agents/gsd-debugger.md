...
<required_reading>
@/workspace/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/workspace/.claude/get-shit-done/references/debugger-philosophy.md
...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspace/.claude/get-shit-done
                  → writes to /workspace/.claude/get-shit-done/hooks/
...
@/workspace/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/workspace/.claude/get-shit-done/references/common-bug-patterns.md
