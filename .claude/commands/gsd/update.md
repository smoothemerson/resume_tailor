...
<execution_context>
@/workspace/.claude/get-shit-done/workflows/update.md
</execution_context>
...
@/workspace/.claude/get-shit-done/workflows/sync-skills.md
@/workspace/.claude/get-shit-done/workflows/reapply-patches.md
</execution_context_extended>
