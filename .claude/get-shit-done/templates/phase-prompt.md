...
<!-- For checkpoint task examples and patterns, see @/workspace/.claude/get-shit-done/references/checkpoints.md -->
...
See `/workspace/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/workspace/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/workspace/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
