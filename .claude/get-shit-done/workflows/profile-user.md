...
Key references:
- @/workspace/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/workspace/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/workspace/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/workspace/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/workspace/.claude/get-shit-done/USER-PROFILE.md" "/workspace/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /workspace/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/workspace/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/workspace/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /workspace/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /workspace/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /workspace/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /workspace/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /workspace/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/workspace/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /workspace/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /workspace/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /workspace/.claude/CLAUDE.md
```
