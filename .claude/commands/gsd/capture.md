...
<execution_context>
@/workspace/.claude/get-shit-done/workflows/add-todo.md
@/workspace/.claude/get-shit-done/workflows/note.md
@/workspace/.claude/get-shit-done/workflows/add-backlog.md
@/workspace/.claude/get-shit-done/workflows/plant-seed.md
@/workspace/.claude/get-shit-done/workflows/check-todos.md
